...
export const registerSchema = yup.object().shape({
  name: yup.string().required("O nome é obrigatório").min(4, "Insira um nome com pelo menos 4 caracteres").max(150, "Insira um nome com no máximo 150 caracteres").matches(/^([^0-9]+)$/, "Não insira números no nome"),
